...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Categoria.estilo'
        db.add_column(u'core_categoria', 'estilo',
                      self.gf('jsonfield.fields.JSONField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Categoria.estilo'
        db.delete_column(u'core_categoria', 'estilo')
    ...
    models = {
        ...
        u'core.categoria': {
            ...
            'estilo': ('jsonfield.fields.JSONField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'marker': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
